...
#define TEST_ATECC608A_PUB_KEY_SIZE                 64u
#define TEST_ATECC608A_PMS_SIZE                     32u
#define TEST_ATECC608A_RAND_NUM_SIZE                32u
...
void main (void)
{
    OCKAM_ERR err;
    uint8_t i;
    uint8_t rand_num[TEST_ATECC608A_RAND_NUM_SIZE];
    uint8_t key_static[TEST_ATECC608A_PUB_KEY_SIZE];
    uint8_t key_ephemeral[TEST_ATECC608A_PUB_KEY_SIZE];
    uint8_t pms_static[TEST_ATECC608A_PMS_SIZE];
    uint8_t pms_ephemeral[TEST_ATECC608A_PMS_SIZE];
    ...
    for(i = 1; i <= TEST_ATECC608A_RAND_NUM_SIZE; i++) {
    ...
    for(i = 0; i < TEST_ATECC608A_PMS_SIZE; i++) {
